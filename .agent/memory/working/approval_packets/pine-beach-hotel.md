...
- Public social signal: Owned website contact page links to public Facebook and Instagram profiles for Pine Beach Hotel.
- Website gap: Owned website exists with menu, whats-on, accommodation, gaming, bottle shop, and contact paths; opportunity is a sharper mobile-first dining/functions/accommodation conversion flow.
- Proposed opportunity: Coastal pub landing page with menu, what's-on, stay, bottle shop, and function enquiry CTAs for locals and visitors.
