...
1. Execute the verification script: `bash .agent/skills/verify-integrity/scripts/assert-state.sh`.
2. This script scans all active website folders for:
...
3. Output the checklist of directories audited and report any validation discrepancies.
