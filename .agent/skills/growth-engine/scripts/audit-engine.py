...
SCHEMAS = {
    ...
    ".agent/memory/working/approval_decision_inbox.csv": ["date","rank","business","approval_type","recommended_decision","approve_command","reject_command","hold_command","approve_effect","reject_effect","hold_effect","social_signal","website_gap","proposed_opportunity","evidence_grade","review_focus","evidence_path","packet_path","safety_gate","notes"],
    ".agent/memory/working/decision_cockpit.csv": ["date","rank","business","decision_type","recommended_decision","evidence_path","approval_packet","private_concept","github_issue_draft","github_status","social_signal","website_gap","proposed_opportunity","evidence_grade","review_focus","approve_command","reject_command","hold_command","after_approve","still_blocked","safety_gate","notes"],
